import{t as e}from"./framework-CNxXF_6U.js";import{a as t,d as n,i as r,n as i,s as a,t as o}from"./signal-WgUxvV6F.js";var s=e(),c={"tic-equities-us":`United States
...
United States`,"tic-canada-us-securities":`Canada →
United States`,"tic-uk-us-securities":`United Kingdom →
United States`,"tic-germany-us-securities":`Germany →
United States`,"tic-france-us-securities":`France →
United States`,"tic-switzerland-us-securities":`Switzerland →
United States`,"tic-australia-us-securities":`Australia →
United States`,"tic-new-zealand-us-securities":`New Zealand →
United States`,"tic-lebanon-us-securities":`Lebanon →
United States`,"tic-us-europe-securities":`United States →
Europe`,"tic-us-asia-securities":`United States →
Asia`,"tic-us-japan-securities":`United States →
Japan`,"tic-us-china-securities":`United States →
China`,"tic-us-india-securities":`United States →
India`,"tic-us-uae-securities":`United States →
UAE`,"tic-us-russia-securities":`United States →
Russia`,"tic-us-latin-america-securities":`United States →
Latin America`,"tic-us-brazil-securities":`United States →
Brazil`,"tic-us-mexico-securities":`United States →
Mexico`,"tic-us-africa-securities":`United States →
Africa`,"tic-us-south-africa-securities":`United States →
South Africa`},l=t.filter(e=>e.sourceId in c&&n(e.sourceId).track===`flowTrend`).sort((e,t)=>Math.abs(t.score)-Math.abs(e.score));function u(){return(0,s.jsx)(i,{title:`Flows`,children:(0,s.jsxs)(`section`,{className:`flow-board`,"aria-labelledby":`page-title`,children:[(0,s.jsxs)(`div`,{className:`flow-board-head`,children:[(0,s.jsx)(`h1`,{id:`page-title`,children:`Cross-border flows`}),(0,s.jsx)(`p`,{children:r.dataThrough})]}),(0,s.jsx)(`div`,{className:`flow-cards`,children:l.map(e=>{let t=e.score>0;return(0,s.jsxs)(`article`,{className:`flow-card tone-${t?`positive`:`negative`}`,children:[(0,s.jsx)(`span`,{className:`flow-arrow`,"aria-hidden":`true`,children:t?`↑`:`↓`}),(0,s.jsx)(`span`,{className:`flow-direction`,children:t?`MONEY MOVING IN`:`MONEY MOVING OUT`}),(0,s.jsx)(`h2`,{children:c[e.sourceId].split(`
